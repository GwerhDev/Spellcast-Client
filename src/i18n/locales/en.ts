export const en = {
  ...
  player: {
    ...
    providerVoicesDesc: 'These voices are provided by external services. Configure your credentials in',
    localVoice: 'Local voice (works offline)',
    networkVoice: 'Network voice (requires a connection)',
