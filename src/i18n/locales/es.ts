...
export const es: Translations = {
  ...
  havenStore: {
    ...
    companionsComingSoon: 'Companions próximamente',
    companionsComingSoonDesc: 'Los companions 3D interactuarán en tus entornos de lectura y escritura en una actualización futura.',
  },
};
