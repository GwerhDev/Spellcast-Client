 ...
 * Tiptap JSONContent page, for use by the read-only TTSSpellReader renderer.
 * Re-computes only when `content` reference changes.
 */
export function useSpellBlocks(content: JSONContent | null | undefined): DocumentBlock[] {
