...
export const companions: Companion[] = [
  {
    ...
    category: 'companion',
    unlockMethod: 'free',
    // "orange" points at its own recolored copy of the black cat asset (same mesh/rig,
    // fur textures recolored — see public/models/cats/orange), generated by replacing
    // each texture's visible (alpha>0) pixels with the flat tint below and leaving alpha
    // untouched, since the source textures store fur shape/softness entirely in alpha
    // with a uniform flat "ink" RGB rather than baked shading.
    models: [
      { id: 'orange', color: '#e0793c', modelUrl: '/models/cats/orange/scene.gltf' },
