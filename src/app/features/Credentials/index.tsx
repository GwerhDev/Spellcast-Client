import s from '../../components/Credentials/Credentials.module.css';
...
export const Credentials = () => {
  ...
  return (
    <div data-testid="credentials" className={s.container}>
      <ul className={s.list}>
        ...
        ))}
        {
          isAddingNewCredential ? (
            ...
            <>
              {
                !loading &&
                <li data-testid="credentials-add" className={s.emptyItem} onClick={handleAdd}>
