import s from '../../components/DocumentDetail/index.module.css';
...
export const DocumentDetail: React.FC = () => {
  ...
  if (isLoading) return (
    <div data-testid="document-detail-loading" className={s.container}>
      <Spinner isLoading message={t.common.loading} />
    </div>
  );
  if (error || !doc) return (
    <div data-testid="document-detail-error">{error || t.document.notFound}</div>
  );
  ...
  return (
    <div data-testid="document-detail" className={s.container}>
