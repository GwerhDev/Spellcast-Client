...
// under (reached here via the "Storage" tab -> Local). No "dashboard-sections" className
  ...
  return (
    <PageTransition>
      <div className={s.pageInfoContainer}>
        <IconButton icon={faArrowLeft} className={s.backButton} variant="transparent" title={t.common.back} onClick={() => navigate('/caster/storage')} />
      </div>
      <BrowserStorage />
    </PageTransition>
  );
