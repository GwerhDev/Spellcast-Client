...
import s from "../../../components/tiptap-ui-primitive/toolbar/toolbar.module.css"
  ...
  ({ children, className, variant = "fixed", ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn(s["tiptap-toolbar"], className)}
        {...props}
      >
        {children}
      </div>
...
export const ToolbarGroup = forwardRef<HTMLDivElement, BaseProps>(
  ({ children, className, ...props }, ref) => (
    <div
      ref={ref}
      role="group"
      className={cn(s["tiptap-toolbar-group"], className)}
      {...props}
    >
      {children}
    </div>
