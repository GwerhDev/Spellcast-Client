...
import s from "../../../components/tiptap-ui-primitive/card/card.module.css"

const Card = forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return <div ref={ref} className={cn(s["tiptap-card"], className)} {...props} />
  }
)
...
const CardHeader = forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(s["tiptap-card-header"], className)}
        {...props}
      />
    )
  }
...
const CardBody = forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return (
      <div ref={ref} className={cn(s["tiptap-card-body"], className)} {...props} />
    )
  }
)
...
>(({ className, orientation = "vertical", ...props }, ref) => {
  return (
    <div
      ...
      className={cn(s["tiptap-card-item-group"], className)}
      {...props}
    />
  )
})
...
const CardGroupLabel = forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(s["tiptap-card-group-label"], className)}
        {...props}
      />
    )
  }
...
const CardFooter = forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(s["tiptap-card-footer"], className)}
        {...props}
      />
    )
  }
